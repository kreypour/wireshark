...
# for calculating install directory size
...
section "uninstall"
    ...
    delete $INSTDIR\gthread-2.dll
    delete $INSTDIR\k5sprt64.dll
    delete $INSTDIR\krb5_64.dll
    delete $INSTDIR\libbcg729.dll
